...
public class MainActivity extends Activity{
    ...
    public static class PlaceholderFragment extends Fragment implements PositionListener {
    	...
    	static List<InterceptPoint> intercept;
    	static GPSCoordinator display = new GPSCoordinator();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			final NavigationalMap map = MapLoader.loadMap(this.getActivity().getExternalFilesDir(null),"Lab-room-peninsula.svg");
